...
export const DEFAULT_PREFS = { tf:'M5', emaVis:{ 9:true, 20:true, 50:true, 200:false }, auto:false, alert:false, autoTrade:false, bgScan:false, onlyStrong:false, waitPullback:false, pbAlert:true, tuneLock:true, minScore:30, source:'auto', ind:{ form:true, boll:false, vwap:false, sr:true, panels:['RSI'] }, smc:{ ...DEFAULT_SMC } };
